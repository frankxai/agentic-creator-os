...
1. **Content Roadmap**: `~/FrankX/docs/CONTENT_ROADMAP.md`
   - Check current week's focus
   - Identify priority content

2. **Foundation Spec**: `~/FrankX/docs/FOUNDATION_SPEC.md`
   - Brand principles
   - Quality standards
...
After successful generation, append to `~/FrankX/public/images/blog/IMAGE_INDEX.md`:
...
| Type | Location |
|------|----------|
| Generated images | `~/FrankX/public/images/blog/` |
| Image index | `~/FrankX/public/images/blog/IMAGE_INDEX.md` |
| Production mirror | `~/FrankX/.worktrees/vercel-ui-ux/public/images/blog/` |
| Content roadmap | `~/FrankX/docs/CONTENT_ROADMAP.md` |
| Foundation spec | `~/FrankX/docs/FOUNDATION_SPEC.md` |
