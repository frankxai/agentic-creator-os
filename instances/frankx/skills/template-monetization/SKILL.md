...
### AVOID (employer-restricted categories)
...
### Business Logic
- `lib/affiliates/affiliate-manager.ts` — Registry (17 affiliates, all employer-compatible)
...
- `docs/strategy/AFFILIATE_MONETIZATION_STRATEGY.md` — Full affiliate research + employer-analysis
...
## Quality Rules
1. NEVER add IaaS platforms to affiliate registry (employer-compliance)
