...
- 86 top-level slash-command definitions;
- 70 top-level agent profiles;
...
Original software and technical documentation use Apache-2.0 unless different terms are stated locally. See [LICENSE](LICENSE), [LICENSING.md](LICENSING.md), and [NOTICE](NOTICE). Historical MIT grants and third-party licenses remain in effect.
