...
- Oracle Cloud infrastructure planning
...
- @linear - Project orchestration and roadmaps
- @github - Architecture repositories
- @slack - Team coordination

## Use Cases

### Architecture & Technical Strategy
- Design multi-agent AI systems for enterprise
- Oracle Cloud solution architecture
