...
server.registerTool("generate_article_summary", {
...
server.registerTool("twitter_post", {
    title: "Post Tweet",
...
server.registerTool("twitter_thread", {
...
server.registerTool("twitter_analytics", {
...
server.registerTool("linkedin_post", {
...
server.registerTool("linkedin_article", {
...
server.registerTool("linkedin_analytics", {
...
server.registerTool("instagram_post", {
...
server.registerTool("instagram_story", {
...
server.registerTool("instagram_analytics", {
...
server.registerTool("farcaster_cast", {
...
server.registerTool("farcaster_thread", {
...
server.registerTool("farcaster_frame", {
...
server.registerTool("farcaster_analytics", {
...
server.registerTool("analytics_aggregated", {
...
server.registerTool("analytics_best_times", {
...
server.registerTool("analytics_trends", {
...
server.registerTool("schedule_content", {
...
server.registerTool("schedule_bulk", {
...
server.registerTool("schedule_reschedule", {
